...
from src.main.database_module import database_module
...
from src.unit_tests.middle_module.parsers import spbu_test_parser, ranepa_test_parser, etu_test_parser
from src.unit_tests.middle_module.database import test_database_module
